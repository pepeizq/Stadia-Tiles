...
Namespace Interfaz
    Module Pestañas
        ...
        Public Sub Visibilidad(gridMostrar As Grid, tag As String, origen As Object)
            ...
            tbTitulo.Text = recursos.GetString("Stadia_Title") + " (" + Package.Current.Id.Version.Major.ToString + "." + Package.Current.Id.Version.Minor.ToString + "." + Package.Current.Id.Version.Build.ToString + "." + Package.Current.Id.Version.Revision.ToString + ")"
