...
Namespace Tiles
    Module Añadir
        ...
        Public Async Sub Generar(tile As Tile)
            ...
            Await Imagen.Generar(gridTilePequeña, tile.IDStadia + "pequena.png", 71, 71)

            Dim gridTileMediana As Grid = pagina.FindName("gridTileMediana")
            Await Imagen.Generar(gridTileMediana, tile.IDStadia + "mediana.png", 150, 150)

            Dim gridTileAncha As Grid = pagina.FindName("gridTileAncha")
            Await Imagen.Generar(gridTileAncha, tile.IDStadia + "ancha.png", 310, 150)

            Dim gridTileGrande As Grid = pagina.FindName("gridTileGrande")
            Await Imagen.Generar(gridTileGrande, tile.IDStadia + "grande.png", 310, 310)

            '-----------------------

            Dim nuevaTile As New SecondaryTile(tile.IDStadia, tile.Titulo, tile.Enlace, New Uri("ms-appdata:///local/" + tile.IDStadia + "ancha.png", UriKind.RelativeOrAbsolute), Windows.UI.StartScreen.TileSize.Wide310x150)
            ...
            nuevaTile.VisualElements.Square71x71Logo = New Uri("ms-appdata:///local/" + tile.IDStadia + "pequena.png", UriKind.RelativeOrAbsolute)
            nuevaTile.VisualElements.Square150x150Logo = New Uri("ms-appdata:///local/" + tile.IDStadia + "mediana.png", UriKind.RelativeOrAbsolute)
            nuevaTile.VisualElements.Wide310x150Logo = New Uri("ms-appdata:///local/" + tile.IDStadia + "ancha.png", UriKind.RelativeOrAbsolute)
            nuevaTile.VisualElements.Square310x310Logo = New Uri("ms-appdata:///local/" + tile.IDStadia + "grande.png", UriKind.RelativeOrAbsolute)
            ...
            Dim fondoImagenMediano As New TileBackgroundImage With {
                .Source = "ms-appdata:///local/" + tile.IDStadia + "mediana.png",
            ...
            Dim fondoImagenAncha As New TileBackgroundImage With {
                .Source = "ms-appdata:///local/" + tile.IDStadia + "ancha.png",
                .HintCrop = AdaptiveImageCrop.Default
            }
            ...
            Dim fondoImagenGrande As New TileBackgroundImage With {
                .Source = "ms-appdata:///local/" + tile.IDStadia + "grande.png",
                .HintCrop = AdaptiveImageCrop.Default
            }
            ...
            Try
                TileUpdateManager.CreateTileUpdaterForSecondaryTile(tile.IDStadia).Update(notificacion)
